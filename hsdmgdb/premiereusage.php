...
$proproducts = db_query_array( "select product_id from reports_amember.am_product  where title like '% premiere %'", "product_id", "product_id" );
...
<h3>Premiere Usage</h3>
<form method='post' action='premiereusage.php'>
Filter By: <br>
<table>
