<? //                  | ELECTRIC VS. ACOUSTIC INSTRUMENTATION                          | 

$vocals = getEnumValues( "ElectricVsAcoustic" );
...
foreach( $quarterstorun as $q )
  {
	...
	if( $addnote )
	  {
	    $songs = db_query_array( "select id from songs where id in ( $songidstr ) and ElectricVsAcoustic = '$t' " );
