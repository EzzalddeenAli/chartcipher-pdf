...
// MariaDB [dbi360_admin]> create table pdfdownloads ( pdfid integer, dateadded datetime , filename varchar( 255 ), type varchar( 255 ), username varchar( 255 ), watermark text );
