 ...
 ?>                
        <section class="home-top">
			<div class="element-container row">
 						...
 						<form class="search-form" method='get' name="benchmarkform" id="benchmarkform" action='cross-chart-report.php'>
      <input type='hidden' name='searchtype' value='Cross Chart'>
...
<div class="range range-short ">to</div>
 ...
 <div class="form-header " >
             <div class="form-row-full quarter-select">
								...
								<div id="crosschartdiv" class="form-row-right-inner">
                                    <div class="select-wrapper">
