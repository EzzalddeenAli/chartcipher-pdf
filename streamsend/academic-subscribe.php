...
$academicins = htmlentities( $_POST['academicins'] );
$jobfunction = htmlentities( $_POST['jobfunction'] );
$phone = htmlentities( $_POST['phone'] );
$state = htmlentities( $_POST['state'] );
$country = htmlentities( $_POST['country'] );
$academicform = htmlentities( $_POST['academicform'] );
...
if ( empty($resp) ) { 
	...
	mail('dave@hitsongsdeconstructed.com, ypenn@i360m.com, thorn@hitsongsdeconstructed.com','New Academic Request (Immersion)', $message, $headers);
	echo '1';
}
