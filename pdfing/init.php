...
if( strpos( $watermark, "watermark=" ) !== false )
    $watermark = str_replace( "watermark=", "", $watermark );
else
    $watermark = "";

$watermark2 = urldecode( $parsed["query"] );
if( strpos( $watermark2, "watermark2=" ) !== false )
    $watermark2 = str_replace( "watermark2=", "", $watermark2 );
else
    $watermark2 = "";
